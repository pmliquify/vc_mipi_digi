...
void vc_init_imx226_ctrl(struct vc_mod_ctrl *ctrl)
{
	...
	ctrl->sen_reg_gain_m 	= IMX226_SEN_REG_EXPO_M;
...
void vc_init_imx327_ctrl(struct vc_mod_ctrl *ctrl)
{
	struct device *dev = &ctrl->client_sen->dev;
	...
	ctrl->sen_reg_gain_m 	= IMX327_SEN_REG_EXPO_M;
