...
TARGET_DIR=/exports/nfsroot-ccimx8x_sbc_pro

if [[ $1 == "a" || $1 == "k" ]]; then      
        sudo cp $SOURCE_DIR/boot/Image.gz $TARGET_DIR/boot/Image.gz--5.4-r0.2-ccimx8x-sbc-pro.bin
fi
...
if [[ $1 == "purge" ]]; then
        ...
        sudo cp Image.gz--5.4-r0.2-ccimx8x-sbc-pro.bin $TARGET_DIR/boot
        sudo cp ccimx8x-sbc-pro--5.4-r0.2-ccimx8x-sbc-pro.dtb $TARGET_DIR/boot
